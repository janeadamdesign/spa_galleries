...
export const eventData: EventData = {
  ...
  1: {
    ...
    description: {
      ...
      2: "Pon de Pantiles nriches the local community by bringing together diverse groups to celebrate and appreciate global carnival traditions, serving as a platform for cultural exchange and fosters a sense of community and inclusivity",
  ...
  2: {
    ...
    description: {
      ...
      1: "Visually, the film distinguishes itself with a stark portrayal of a dystopian world that resembles a post-apocalyptic horror film. Directed with a keen eye for tension, the film utilizes daylight to enhance the haunting atmosphere, making each scene a grim reflection of a divided society",
  ...
  4: {
    ...
    dateVector: [4, 1],
    description: {
      0: "Join us for an enlightening lecture by Philip Bret-Day, delving into the complex legacy of Leni Riefenstahl, a filmmaker whose work during the Nazi era has speaked intense debate and scrutiny, prompted by new reveleations from a documentary suggesting Riefenstahl was not only a witness to Nazi atrocities but an active participant in them.",
      1: "Damning new evidence from her estate reveals her continued admiration for Nazi ideology until her death in 2003, exposing her presence at a massacre of Polish Jews in 1939, challenging her previous denialsa and suggesting her directions during filming may have inspired the violence.",
  ...
  5: {
    ...
    description: {
      ...
      1: "Metropolis is known for its groundbreaking special effects and set design that vividly capture the mechanized cityscape. Its towering skyscrapers and complex machinery served as early blueprints for cinematic depictions of futuristic cities.",
      ...
      4: "The film challenges viewers with its depiction of technology and industrialization impacting human relations and social order, posing enduring questions about progress and humanity",
    },
  },
};
